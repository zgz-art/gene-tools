...
8. 对于项目角色的描述不能只是一个简单的岗位名称，还要有相应的工作内容或者责任描述，尽量控制在4条以内。
...
5. 项目经验清晰度（20分）：项目描述是否详细、有量化成果、技术深度。能说清自己负责的模块、使用技术、解决的具体问题，而不能只写“参与xx系统开发”，没有体现个人贡献。以及项目与当前岗位的匹配度。
