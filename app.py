...
def fill_education_block(ws, keyword, edu_data):
...
def fill_template(template_path, output_path, ai_data):
    ...
    if ai_data.get("education", {}).get("undergraduate"):
        fill_education_block(ws, "本科学历", ai_data["education"]["undergraduate"])
    if ai_data.get("education", {}).get("postgraduate"):
        fill_education_block(ws, "研究生学历", ai_data["education"]["postgraduate"])
